...
public:
    ...
    void SetMove(Float x, Float y, Float cx, Float cy);
    ...
    void SetCaptionHeight(Float val);
...
protected:
    ...
    virtual void OnWidthChanged(Float oldVal, Float newVal);
    virtual void OnHeightChanged(Float oldVal, Float newVal);
    virtual void OnMinWidthChanged(Float oldVal, Float newVal);
    virtual void OnMinHeightChanged(Float oldVal, Float newVal);
    virtual void OnMaxWidthChanged(Float oldVal, Float newVal);
    virtual void OnMaxHeightChanged(Float oldVal, Float newVal);
    ...
    virtual void OnLocationChanged(fPoint oldVal, fPoint newVal);
...
protected:
    ...
    void UpdateMeasureSize(const fSize& availableSize, fSize& measureSize);
