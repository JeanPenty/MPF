...
public:
    ...
    void ReadItemSize(ItemEntry* item, bool bHori, int index, fSize& size);
    void StoreItemSize(ItemEntry* item, int index, fSize size);
...
protected:
    ...
    virtual fSize EstimatedContainerSize(bool isHorizontal);
...
protected:
    ...
    int ComputeOffsetFromItem(Object* item, Float& offset, Float& itemSize);
    int ComputeOffsetFromIndex(int index, Float& offset, Float& itemSize);

    bool MakeVisible(int index);
    bool MakeVisible(int index, bool atTopOfViewport);
    bool MakeVisible(Object* item, Float offset, Float iItemSize, bool atTopOfViewport);
    ...
    void NavigateToItem(Object* item, Float offset, Float itemLen, ItemNavigateArg* e, bool alwaysAtTopOfViewport);
