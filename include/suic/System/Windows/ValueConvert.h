...
class SUICORE_API AutoFpConvert : public IConvertValue
{
public:

    static AutoFpConvert* Convert;
...
class SUICORE_API AutoF0Convert : public IConvertValue
{
public:

    static AutoF0Convert* Convert;
