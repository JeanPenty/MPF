...
struct ContainerSize : public Object
{
    ...
    {
        return FloatUtil::AreClose(size, cSize.size);
    }
};
...
public:
    ...
    void RegisterContainerSize(Float size);
    fSize EstimatedContainerSize(bool isHorizontal);
...
protected:
    ...
    bool ComputeItemOffset(ItemCollection* items, bool bHori, Object* item, Float& iOffset, Float& iItemSize);
