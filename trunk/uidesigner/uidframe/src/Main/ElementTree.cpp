...
void ElementTreeItem::ArrangeCore(const suic::fRect& arrangeRect)
{
    ...
    _descendantBounds = fRect(_canvasOffset, _renderSize);
}
...
void TreeItemGrid::OnArrange(const suic::fSize& rect)
{
    //suic::Grid::OnArrange(rect);
}

void TreeItemGrid::ArrangeCore(const suic::fRect& arrangeRect)
{
}
