...
public:
    ...
    void SetElementWidth(DesignElement* elem, Float wid);
    void SetElementHeight(DesignElement* elem, Float hei);
    void SetElementMargin(DesignElement* elem, fRect rect);
...
protected:
    ...
    fSize OnMeasure(const suic::fSize& constraitSize);
