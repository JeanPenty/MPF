...
suic::fSize Embbed::GetDesiredSize()
{
    return _desiredSize;
}

suic::fPoint Embbed::GetVisualOffet() const
{
    return _offset;
}

suic::fSize Embbed::GetRenderSize() const
{
    return _renderSize;
}

void Embbed::Arrange(const suic::fRect& arrangeRect)
{
    OnArrange(arrangeRect);
}

void Embbed::Measure(const suic::fSize& contraint)
{
    OnMeasure(contraint);
}

void Embbed::OnArrange(const suic::fRect& arrangeRect)
{
    _offset.x = arrangeRect.left;
    _offset.y = arrangeRect.top;
    _renderSize = arrangeRect.TofSize();
}

void Embbed::OnMeasure(const suic::fSize& contraint)
{
...
void ImageEmbbed::OnMeasure(const suic::fSize& contraint)
{
...
void PlayImageEmbbed::SetPlaySize(suic::fSize size)
{
    _playSize = size;
}
